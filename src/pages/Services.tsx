...
export default function ({
  ...
  const [services, servicesLoading, servicesError]: [Array<Service>, boolean, ErrorRoute] = useApi(
    servicesMethod,
    true,
    servicesArgs,
  )
  const [team, teamLoading, teamError]: [Team, boolean, ErrorRoute] = useApi('getTeam', !!teamId, [teamId])
