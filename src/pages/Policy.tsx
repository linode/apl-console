...
import { GetPolicyApiResponse, useEditPolicyMutation, useGetAplTeamsQuery, useGetPolicyQuery } from 'redux/otomiApi'
...
export default function ({
  ...
  const team = !isLoadingTeams && find(teams, { metadata: { name: teamId } })

  const editPolicies =
    team?.spec?.selfService?.teamMembers?.editSecurityPolicies || teamId === 'admin' || isPlatformAdmin
