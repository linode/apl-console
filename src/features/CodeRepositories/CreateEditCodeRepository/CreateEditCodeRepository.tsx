...
import { createCoderepoApiResponseSchema } from './CreateEditCodeRepository.validator'
...
export default function ({
  ...
  const methods = useForm<any>({
    resolver: yupResolver(createCoderepoApiResponseSchema),
  ...
  if (isSuccessCreate || isSuccessUpdate) return <Redirect to={`/teams/${teamId}/code-repositories`} />
