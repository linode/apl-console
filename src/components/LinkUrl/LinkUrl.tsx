...
export const Link = React.forwardRef<HTMLAnchorElement, LinkProps>((props, ref) => {
  const { accessibleAriaLabel, children, className, external, forceCopyColor, hideIcon, onClick, to } = props
  ...
  const routerLinkProps = omitProps(props, ['accessibleAriaLabel', 'external', 'forceCopyColor'])
