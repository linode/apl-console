...
const Logo = forwardRef<any, Props>(({ disabledLink = false, width = 60, height = 60, sx }, ref) => {
  const logo = (
    <Box ref={ref} sx={{ width, height, cursor: 'pointer', ...sx }}>
      <svg viewBox='0 0 100 108' version='1.1' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g id='Page-1' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
          <g id='akamai-logo-rgb' transform='translate(0.600000, 0.700000)' fill='#009CDE' fillRule='nonzero'>
            <path
