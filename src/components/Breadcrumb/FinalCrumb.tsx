...
import { StyledDiv, StyledEditableText, StyledH1Header } from './FinalCrumb.styles'
...
export const FinalCrumb = React.memo((props: Props) => {
  const { crumb, disabledBreadcrumbEditButton, labelOptions, onEditHandlers } = props
  ...
  return (
    <StyledDiv>
      <StyledH1Header
        sx={{
          ...(labelOptions && labelOptions.noCap && { textTransform: 'initial' }),
        }}
        dataQaEl={crumb}
        title={crumb}
      />
